...
public final class CompilerDef extends ProcessorDef {
	 ...
	 * should recognized the settings from the appropriate environment variables or
	 * configuration files.
	 */
	...
	/**
	 * Sets the default compiler adapter. Use the "name" attribute when the compiler
	 * is a supported compiler.
	 * 
